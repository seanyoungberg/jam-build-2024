...
variable "instance_name_suffix" {
  description = "ASG instance suffix name will be appended with this string"
  type        = string
  default     = "vmseries"
}
...
variable "health_check_grace_period" {
  description = "Grace period for instances to finish initializing before they are checked for health by Auto Scaling."
  type        = number
  default     = 300
}
