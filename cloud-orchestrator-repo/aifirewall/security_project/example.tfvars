### GENERAL
region      = "ap-southeast-2" # REPLACE-WITH customer region
name_prefix = "demoaws1-"      # REPLACE-WITH prefix to be used in deployment
...
ssh_key_name = "rimu-keypair-sydney" # REPLACE-WITH Keypair created
...
vpcs = {
  ...
  security_vpc = {
    ...
    subnets = {
      ...
      "10.100.0.0/24"  = { az = "ap-southeast-2a", set = "mgmt", nacl = null }                         # REPLACE-WITH customer region's zones
      "10.100.64.0/24" = { az = "ap-southeast-2b", set = "mgmt", nacl = null }                         # REPLACE-WITH customer region's zones
      "10.100.1.0/24"  = { az = "ap-southeast-2a", set = "private", nacl = "trusted_path_monitoring" } # REPLACE-WITH customer region's zones
      "10.100.65.0/24" = { az = "ap-southeast-2b", set = "private", nacl = "trusted_path_monitoring" } # REPLACE-WITH customer region's zones
      "10.100.3.0/24"  = { az = "ap-southeast-2a", set = "tgw_attach", nacl = null }                   # REPLACE-WITH customer region's zones
      "10.100.67.0/24" = { az = "ap-southeast-2b", set = "tgw_attach", nacl = null }                   # REPLACE-WITH customer region's zones
      "10.100.5.0/24"  = { az = "ap-southeast-2a", set = "gwlb", nacl = null }                         # REPLACE-WITH customer region's zones
      "10.100.69.0/24" = { az = "ap-southeast-2b", set = "gwlb", nacl = null }                         # REPLACE-WITH customer region's zones
      "10.100.10.0/24" = { az = "ap-southeast-2a", set = "gwlbe_eastwest", nacl = null }               # REPLACE-WITH customer region's zones
      "10.100.74.0/24" = { az = "ap-southeast-2b", set = "gwlbe_eastwest", nacl = null }               # REPLACE-WITH customer region's zones
      "10.100.11.0/24" = { az = "ap-southeast-2a", set = "natgw", nacl = null }                        # REPLACE-WITH customer region's zones
      "10.100.75.0/24" = { az = "ap-southeast-2b", set = "natgw", nacl = null }                        # REPLACE-WITH customer region's zones
    }
    routes = {
  ...
  main_asg = {
    ...
    interfaces = {
      private = {
        ...
        subnet = {
          "privatea" = "ap-southeast-2a", # REPLACE-WITH customer region's zones
          "privateb" = "ap-southeast-2b"  # REPLACE-WITH customer region's zones
        }
      ...
      mgmt = {
        ...
        subnet = {
          "mgmta" = "ap-southeast-2a", # REPLACE-WITH customer region's zones
          "mgmtb" = "ap-southeast-2b"  # REPLACE-WITH customer region's zones
        }
    ...
    vmseries_ami_id = "ami-083ff395d0ffa4491" # REPLACE-WITH Custom AMI
...
vmseries = {
  tc1 = {
    vmseries_ami_id = "ami-090be8e4a45e9081a"
    instances = {
