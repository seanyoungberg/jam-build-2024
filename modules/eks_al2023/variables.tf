...
## Had to pull module locally because this is hard coded to false
variable "default_bootstrap_cluster_creator_admin_permissions" {
  description = "Uses default EKS API and TF resource behavior for this. Module was hardcoding around it"
  type        = bool
  default     = false
}
